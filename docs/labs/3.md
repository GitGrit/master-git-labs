...
1. In your repository in BitBucket, use the branch dropdown to see how the same file has different contents in each branch.
1. In BitBucket, under the Code tab, click the link that says "3 branches".
